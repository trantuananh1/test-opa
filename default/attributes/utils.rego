package vauthz.generated.abac.utils
...
# __custom_user_attributes = data.vauthz.custom.custom_user_attributes

# __custom_tenant_attributes = data.vauthz.custom.custom_tenant_attributes

# __custom_role_attributes = data.vauthz.custom.custom_role_attributes

# __custom_resource_attributes = data.vauthz.custom.custom_resource_attributes

# __custom_context_attributes = data.vauthz.custom.custom_context_attributes
...
#   stored - Attributes from vauthz's database and backend
